                ...
                <div className="flex flex-col items-center mr-8">
                    ...
                    <div className="text-center">
                        ...
                        <div className="flex mt-4 space-x-4">
                            <button className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">Chat</button>
                            <button className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-md">Video Call</button>
                        </div>
                    </div>
                </div>
