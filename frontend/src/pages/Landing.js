...
const Landing = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-blue-200 to-purple-500 min-h-screen flex flex-col justify-center items-center">
      <header className="text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 p-4">
          <div className="bg-gray-100 rounded-lg p-6 flex flex-col items-center justify-center shadow-lg">
        ...
        <div className="absolute bottom-0 mb-4">
          <p className=" text-sm">&copy; 2024 Pangea Telemedicine. All rights reserved.</p>
        </div>
      </header>
    </div>
  );
